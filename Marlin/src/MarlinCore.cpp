...
#include "lcd/menu/stamp/menu_stamp.h" // Custom Stamp UI: Start Screen
...
void setup() {
  ...
  // Optionaler Rettungsanker:
  // Wenn beim Boot die Encoder-Taste gedrückt ist, NICHT in mein UI springen.
  if (!ui.button_pressed()) {
    ui.goto_screen(menu_stamp_start);
    ui.defer_status_screen();   // verhindert automatische Rückkehr zum Statusscreen
  }
  #endif
