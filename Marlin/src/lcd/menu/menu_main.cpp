...
//Noch nicht ganz sicher was jedes macht aber fragt halt features ab.
#if HAS_GAMES && DISABLED(LCD_INFO_MENU)
  #include "game/game.h"
#endif

// Custom Stamp UI
//#include "Stamp/menu_stamp.h"
...
//Hier werden alle menus eingefügt, direkt darunter werden zusätzliche menus eingefügt falls der printer die Funktionen unterstützt. (Configuration files)
void menu_tune();
...
//Hier werden einfach abgefragt was der printer alles hat, wenn er Power Monitor aht dann wird das menu angezeigt:
